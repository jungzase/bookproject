...
public class H2BookDAO implements BookDAO {
	...
	public void update(Book book) {
	    ...
	    String sql = "UPDATE books SET product_name=?, author=?, publisher=?, publication_date=?, price=?, category=?, img_link=? WHERE isbn=?";
	...
	public void insert(Book book) {
	    String sql = "INSERT INTO books (isbn, product_name, author, publisher, publication_date, price, category, img_link) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
	    ...
	    try (Connection conn = DB.getConnection();
	        ...
	        int result = ps.executeUpdate();
	        System.out.println(result + "개의 도서가 성공적으로 추가되었습니다.");//콘솔 확인용
